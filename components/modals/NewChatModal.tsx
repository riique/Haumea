...
import type { ChatConfig, Memory } from '@/types/chat';
import { MemoriesManager } from '@/components/common/MemoriesManager';

interface NewChatModalProps {
  isOpen: boolean;
  onClose: () => void;
  onCreateChat: (config: ChatConfig) => Promise<void>;
}
        ...
        <div className="flex items-center justify-between p-6 border-b border-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Configure os parâmetros do chat</p>
            </div>
          </div>
          <button
            onClick={onClose}
